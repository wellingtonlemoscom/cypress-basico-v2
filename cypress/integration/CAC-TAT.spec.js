...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche campo text area usando delay', function() {
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function() {
        cy.get('#firstName').type('Wellington')
        cy.get('#lastName').type('Lemos')
        cy.get('#email').type('wellingtonlemos')
        cy.get('#open-text-area').type('teste')
        cy.contains('button', 'Enviar').click()
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('wellingtonlemos@email.com')
            .should('have.value', 'wellingtonlemos@email.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type(12345678)
